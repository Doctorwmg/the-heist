...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center px-4 bg-[var(--bg-primary)]">
        <div className="w-full max-w-sm space-y-4 text-center">
          <h1 className="font-display text-2xl tracking-wider text-[var(--accent-primary)]">CHECK YOUR EMAIL</h1>
          ...
          <button
            ...
            className="mt-4 text-[var(--accent-primary)] hover:text-[var(--accent-secondary)] font-mono text-sm"
          >
            Back to login
          </button>
        </div>
    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center px-4 bg-[var(--bg-primary)]">
      ...
      <div className="relative z-10 w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-xs uppercase tracking-widest text-[var(--text-secondary)]">Create Your Operative Account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-xs font-medium uppercase tracking-wider text-[var(--text-secondary)]">
              Codename
            </label>
            <input
              id="username"
        ...
        <p className="text-center text-xs text-[var(--text-secondary)]">
          ...
          <Link href="/login" className="text-[var(--accent-primary)] hover:text-[var(--accent-secondary)]">
            Sign in
          </Link>
        </p>
      </div>
